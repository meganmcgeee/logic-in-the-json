...
app.launch(function (request, response) {
  var launchOutput = 'Welcome to Your Skill.  The purpose of this skill is to do-ah the cha cha  To start using the skill, say Alexa, ask ....'
