...
class BSTConfig {
    ...
    static updateConfig(config) {
        return __awaiter(this, void 0, Promise, function* () {
            const generatedConfig = yield BSTConfig.createConfig(config.nodeID);
    ...
    static createConfig(nodeID) {
        return __awaiter(this, void 0, Promise, function* () {
            const lambdaConfig = lambda_config_1.LambdaConfig.defaultConfig().lambdaDeploy;
            const pipeInfo = yield BSTConfig.createExternalResources(nodeID);
            return {
    ...
    static createExternalResources(nodeID) {
        return __awaiter(this, void 0, Promise, function* () {
